...
//    }
    ...
    private void btnArtmn94(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnArtmn94
        dispose();
        ProgressBar.create(DicColor.this.getOwner(), new ListenerFrame() {
            public void actionRequest(Object obj) {
                App.Colors.createFrame(DicColor.this.getOwner(), listener);
            }
        });
    ...
    public static HashSet<Record> filterTxt(List<Record> colorSrc, String colorTxt) {
        ...
        try {
            ...
            System.err.println("РћС€РёР±РєР°: DicColor.filterTxt() " + e);
        }
        return colorRet;
    }
    ...
    public static HashSet<Record> filterDet(HashSet<Record> colorSrc, List<Record> artdetList, Field field) {
        ...
        try {
            ...
            System.err.println("РћС€РёР±РєР°: DicColor.filterDet() " + e);
        }
        return colorSet;
    }
}
