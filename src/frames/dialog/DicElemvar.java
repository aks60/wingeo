...
//Варианты составов
public class DicElemvar extends javax.swing.JDialog {

    private ListenerRecord listener = null;
    private int paramElem = 0;
    String[] titl = {"Наименование"};
    Object[][] rows;

    public DicElemvar(java.awt.Frame parent, ListenerRecord listenet, int paramElem) {
        super(parent, true);
        initComponents();
        initElements();
    ...
    public void loadingModel() {
        ...
        if (paramElem != -1) {
            ...
            if (paramElem == 0 || paramElem == 100000) {
    ...
    private void initComponents() {
        ...
        btnRemove.setToolTipText(bundle.getString("Удалить")); // NOI18N
