...
//                                                                    }
//                                                                } else {
//                                                                    for (Com5t com6 : ((AreaSimple) com5).childs) {
//                                                                        if (com6.type != Type.STVORKA) {
//                                                                            if (com6 instanceof ElemSimple) {
//                                                                                frm.add(new DefMutableTreeNode(com6));
//                                                                                if (com6.type != Type.GLASS) {
//                                                                                    frm.getLastChild().add(new DefMutableTreeNode(new Com5t(Type.JOINING) {
//                                                                                    }));
//                                                                                }
//                                                                            }
//                                                                        } else {
//                                                                            loadWinTree(winc, root, com6); //створка    
//                                                                        }
//                                                                    }
//                                                                }
//                                                            } else {
