...
public class Specifics extends javax.swing.JFrame {
    ...
    public void loadingTab1(List<TRecord> listTRec) {
        ...
        v.set(v.size() - 2, UCom.format(winc.price1() + Kitcalc.price(1), "#,##0.##")); //стоимость без скидки
        v.set(v.size() - 1, UCom.format(winc.price2() + Kitcalc.price(2), "#,##0.##")); //стоимость со скидклй              
        dtm.addRow(v);
        labSum.setText("Итого: " + UCom.format(winc.price2() + Kitcalc.price(2), "#,##0.##"));
    }
