...
public class Param extends javax.swing.JFrame {
    ...
    public void selectionTab1(ListSelectionEvent event) {
        ...
        if (index != -1) {
            ...
            qParams.sql(eParams.data(), eParams.groups_id, id).sort(eParams.text);
    ...
    private void initComponents() {
        ...
        tab4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Группа", "Текстура профиля", "Группа", "Текстура элемента", "Соединения", "Составы", "Заполнения", "Фурнитура", "Откосы", "Комплекты", "ID"
            }
        ) {
            Class[] types = new Class [] {
