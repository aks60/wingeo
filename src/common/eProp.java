...
public enum eProp {
    ...
    prjprodID("-1"), //выбранный продукт дл€ клиента
    ...
    public static boolean dev = false; //признак разработки и тестировани€
    public final static String node = "99"; //("00"-демо, "01-98"-продакшен, "99"-разаботка)
    public final static String version = "2.0";
    public static String profile = ""; //профиль разработки и тестировани€
    ...
    //«начение по умолчанию дл€ конкретной OS
