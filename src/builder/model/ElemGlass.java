    ...
    public void addSpecific(Specific spcAdd) {
        try {
            ...
            if (UseUnit.METR.id == spcAdd.artiklRec.getInt(eArtikl.unit)) {
                ...
                LineSegment segm1 = UGeo.newSegment(this.area, indexSegm -1);
                LineSegment segm2 = UGeo.newSegment(this.area, indexSegm + 1);
                LineSegment segm3 = UGeo.newSegment(this.area, indexSegm + 2);
