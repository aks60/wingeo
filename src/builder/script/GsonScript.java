...
// <editor-fold defaultstate="collapsed" desc="RECTANGL">
        if (prj == 601006) { //PUNIC = 427595
            rootGeo = new GsonRoot("2.0", prj, 1, 110, Type.RECTANGL, "RAZIO\\RAZIO 58 N\\1 ОКНА", 1009, 1009, 1009);
            ...
            rootGeo = new GsonRoot("2.0", prj, 1, 81, Type.RECTANGL, "Darrio\\DARRIO 200\\1 ОКНА", 1009, 10009, 1009);
            rootGeo.addElem(new GsonElem(Type.FRAME_SIDE, .0, .0))
            ...
            rootGeo.addArea(new GsonElem(Type.AREA)).addElem(new GsonElem(Type.GLASS));
            rootGeo.addElem(new GsonElem(Type.IMPOST, 0.0, 400.0, 1440.0, 400.0));
