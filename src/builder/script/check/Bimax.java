...
// <editor-fold defaultstate="collapsed" desc="RECTANGL">
        ...
        if (prj == 508852) { //PS перепутаны системы!
            ...
            rootGson = new GsonRoot("2.0", 427653, prj, 3, 41, Type.RECTANGL, "Rehau / Sib / 1 ОКНА", 1009, 1009, 1009);
            ...
            area.addElem(new GsonElem(Type.IMPOST, 650.0, 1700.0, 650.0, 550.0));
            ...
            rootGson = new GsonRoot("2.0", 427746, prj, 1, 366, Type.RECTANGL, "Wintech / Isotech 530 (серый уплотнитель) / 1 ОКНА", 1009, 1009, 1009);
            rootGson.addElem(new GsonElem(Type.FRAME_SIDE, .0, .0))
