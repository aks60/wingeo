...
//                    break;
                ...
                case 31051:  //Если створка фурнитуры 
                    if (elem5e.owner.type == Type.STVORKA) {
                        if ("ведущая".equals(rec.getStr(TEXT)) == true && ((AreaStvorka) elem5e.owner).handRec.getInt(eArtikl.id) == -3) {
                            return false;
                        } else if ("ведомая".equals(rec.getStr(TEXT)) == true && ((AreaStvorka) elem5e.owner).handRec.getInt(eArtikl.id) != -3) {
                            return false;
                        }
                    }
                    break;
