...
public class FurnitureTest {
    ...
    public void furnitureVar() {
        try {
            ...
            System.err.println("builder.param.check.FurnitureTest.furnitureVar() - ВЫПОЛНЕНО");
        } catch (Exception e) {
            System.err.println("Ошибка:furnitureTest.furnitureVar() " + e);
        }
    }
...
//        assert false == furnitureDet3.check(mapParam, area3_stv_right, param("Да", grup)) : grup;
            ...
            System.err.println("builder.param.check.FurnitureTest.furnitureDet() - ВЫПОЛНЕНО");
        } catch (Exception e) {
            System.err.println("Ошибка:furnitureTest.furnitureDet() " + e);
        }
    }
}
