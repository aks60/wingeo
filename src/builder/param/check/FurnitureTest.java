...
public class FurnitureTest {
    ...
    public void furnitureVar() {
        try {
            ...
            System.out.println("builder.param.check.FurnitureTest.furnitureVar() - ВЫПОЛНЕНО");
        } catch (Exception e) {
...
//        assert false == furnitureDet3.check(mapParam, area3_stv_right, param("Да", grup)) : grup;
            ...
            System.out.println("builder.param.check.FurnitureTest.furnitureDet() - ВЫПОЛНЕНО");
        } catch (Exception e) {
