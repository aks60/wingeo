...
public class JoiningTest {
    ...
    public void joiningVar() {
        ...
        assert true == joiningVar2.check(iwin2.listJoin.join(frame2_left, 0), param("1/1", grup)) : grup;
        ...
        assert true == joiningVar2.check(iwin2.listJoin.join(frame2_left, 1), param("30", grup)) : grup;
        assert false == joiningVar2.check(iwin2.listJoin.join(frame2_left, 1), param("32", grup)) : grup;
        ...
        assert true == joiningVar4.check(iwin4.listJoin.join(stv4_right, 0), param("Нет", grup)) : grup;
        assert false == joiningVar4.check(iwin4.listJoin.join(stv4_right, 0), param("Да", grup)) : grup;

        grup = 1020; //Ограничение угла к горизонту, °
        assert true == joiningVar4.check(iwin4.listJoin.join(stv4_right, 1), param("30;270", grup)) : grup;
        ...
        assert true == joiningVar4.check(iwin4.listJoin.join(stv4_right, 1), param("1;2;", grup)) : grup;
        assert false == joiningVar4.check(iwin4.listJoin.join(stv4_right, 1), param("2;9", grup)) : grup;
...
//        assert false == joiningVar4.check(iwin_4.listJoin.get(stv_right_4, 1), param("правый", grup)) : grup;
        ...
        assert false == joiningVar4.check(iwin4.listJoin.join(stv4_right, 1), param("30-89,98;90,11-179,9;180,1-269,9;270,1-359,9;", grup)) : grup;
        assert true == joiningVar4.check(iwin4.listJoin.join(stv4_right, 1), param("89,98-90,1", grup)) : grup;
        assert true == joiningVar4.check(iwin4.listJoin.join(stv4_right, 1), param("90", grup)) : grup;
        ...
        assert false == joiningVar4.check(iwin4.listJoin.join(stv4_right, 1), param("_Армирование", grup)) : grup;
    ...
    public void joiningDet() {
        ...
        assert true == joiningDet2.check(mapParam, iwin2.listJoin.join(frame2_right, 1), param("KBE 58;/KBE 58;", grup)) : grup;
        assert true == joiningDet2.check(mapParam, iwin2.listJoin.join(frame2_right, 1), param("KBE 58;/KBE 58", grup)) : grup;
        assert false == joiningDet2.check(mapParam, iwin2.listJoin.join(frame2_right, 1), param("KBE 58;/KBE 5", grup)) : grup;
...
//        assert false == joiningDet2.check(mapParam, iwin_2.listJoin.get(frame_right_2, 1), param("null", grup)) : grup;
        ...
        assert true == joiningDet2.check(mapParam, iwin2.listJoin.join(frame2_right, 1), param("1009-1010", grup)) : grup;
        assert false == joiningDet2.check(mapParam, iwin2.listJoin.join(frame2_right, 1), param("1006", grup)) : grup;

        grup = 11095; //12095 //Если признак системы конструкции
        assert true == joiningDet2.check(mapParam, iwin2.listJoin.join(frame2_right, 1), param("1;5;4;", grup)) : grup;
        assert false == joiningDet2.check(mapParam, iwin2.listJoin.join(frame2_right, 1), param("5;4;", grup)) : grup;
    }
}
