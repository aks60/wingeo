...
public class JoiningTest {
    ...
    public void joiningVar() {
        try {
            ...
            assert false == joiningVar4.check(UCom.join(iwin4.listJoin, stv4_right_3, 0), param("Нет", grup)) : grup;
            assert false == joiningVar4.check(UCom.join(iwin4.listJoin, stv4_right_3, 0), param("Да", grup)) : grup;
            ...
            assert true == joiningVar2.check(UCom.join(iwin2.listJoin, stv2_left_3, 1), param("поворотное", grup)) : grup;
            assert false == joiningVar2.check(UCom.join(iwin2.listJoin, stv2_left_3, 1), param("поворотно-откидное", grup)) : grup;
...
//        assert false == joiningVar4.check(iwin_4.listJoin.get(stv_right_4, 1), param("правый", grup)) : grup;
            ...
            assert true == joiningVar4.check(UCom.join(iwin4.listJoin, frame4_right, 1), param("Армирование", grup)) : grup;
            assert false == joiningVar4.check(UCom.join(iwin4.listJoin, stv4_right_3, 1), param("_Армирование", grup)) : grup;
            ...
            assert true == joiningVar4.check(UCom.join(iwin4.listJoin, frame4_right, 1), param("Простое L-обр", grup)) : grup;
            ...
            System.out.println("builder.param.check.JoiningTest.joiningVar() - ВЫПОЛНЕНО");
        } catch (Exception e) {
...
//        assert false == joiningDet2.check(mapParam, iwin_2.listJoin.get(frame_right_2, 1), param("null", grup)) : grup;
            ...
            System.out.println("builder.param.check.JoiningTest.joiningDet() - ВЫПОЛНЕНО");
        } catch (Exception e) {
