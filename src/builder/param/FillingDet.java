    ...
    public boolean check(HashMap<Integer, String> mapParam, ElemSimple elem5e, Record rec) {
        ...
        try {
            switch (grup) {
                ...
                {
                    ElemSimple elem = UCom.layout(winc.root.frames, Layout.BOT);
                ...
                {
                    ElemSimple e = UCom.layout(winc.root.frames, Layout.BOT);
                ...
                {
                    ElemSimple elem = (elem5e.owner.frames.isEmpty() == false) ? UCom.layout(elem5e.owner.frames, Layout.BOT) : UCom.layout(elem5e.root.frames, Layout.BOT);
