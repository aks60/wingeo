...
public enum eRulecalc implements Field {
    ...
    common("16", "5", "1", "По всем артикулам проекта", "RALLP"),
    ...
    size("12", "96", "1", "Габариты", "RSIZE"),
    suppl("8", "15", "1", "Надбавка", "RPRIC"),
    sebes("16", "5", "1", "Флаг себест./цена", "RSEBE"),
    calk("5", "5", "1", "Калькуляция (НЕ ИСПОЛЬЗУЮ)", "RCALK"),
