...
public enum ePrjpart implements Field {
    ...
    disc1("8", "15", "1", "Скидки на профиль %", "DESC1"),
    disc2("8", "15", "1", "Скидки на аксессуары", "DESC2"),
    disc3("8", "15", "1", "Скидка на уплотнение", "DESC3"),
    disc5("8", "15", "1", "Скидка на заполнение", "DESC5"),
