...
public enum eProject implements Field {
    ...
    price1win("8", "15", "1", "Cтоимость конструкций без скидки", "KPRIC"),   
    price1kit("8", "15", "1", "Cтоимость комплектации без скидки", "APRIC"),    
    price2win("8", "15", "1", "Cтоимость конструкции со скидками", "KPRCD"),
    price2kit("8", "15", "1", "Cтоимость комплектации со скидками", "APRCD"), 
