...
public enum eProject implements Field {
    ...
    price1a("8", "15", "1", "Cтоимость конструкций без скидки", "KPRIC"),   
    price1b("8", "15", "1", "Cтоимость комплектации без скидки", "APRIC"), 
    price1c("8", "15", "1", "Cтоимость проекта без скидок", "PPRIC"),
    
    price2a("8", "15", "1", "Cтоимость конструкции со скидками", "KPRCD"),
    price2b("8", "15", "1", "Cтоимость комплектации со скидками", "APRCD"), 
    price2c("8", "15", "1", "Cтоимость проекта со скидками", "PPRCD"),
    ...
    //vendor_id("4", "10", "1", "Продавец", "vendor_id"), //пока не использую
