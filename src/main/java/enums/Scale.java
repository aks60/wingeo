...
public enum Scale {
    ...
    public static boolean norm_otx = !(eGroups.find(2007).getInt(eGroups.val) == 0); //учитывать норму отхода в себестоимости
    ...
    //public static Record cursYesBase = null; //кросс-курс валюты для основной текстуры
    //public static Record cursNoBase = null;  //кросс-курс валюты для неосновных текстур (внутренняя, внешняя, двухсторонняя)
