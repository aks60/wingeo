...
public class Artikles extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        texcod.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c085.gif"))); // NOI18N
        ...
        analog.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c085.gif"))); // NOI18N
        ...
        width.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c087.gif"))); // NOI18N
        ...
        mInsert2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c033.gif"))); // NOI18N
        ...
        mDelit2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c034.gif"))); // NOI18N
        ...
        tab2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Группа", "Название", "Применить", "Основная", "Применить", "Внутренняя", "Применить", "Внешняя", "Двухсторонняя", "За ед. веса", "Коэф. накл.расходов", "ID"
            }
        ) {
            Class[] types = new Class [] {
        ...
        lab11.setText("                                                              " + java.util.ResourceBundle.getBundle("hints/okno", common.eProp.locale).getString("Title.Текстуры артикулов")); // NOI18N
