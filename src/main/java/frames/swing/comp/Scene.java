...
public class Scene extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c036.gif"))); // NOI18N
        ...
        btnSave.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
        ...
        btnRevert.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c039.gif"))); // NOI18N
        ...
        btnRevert.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
        ...
        btnMovUp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c051.gif"))); // NOI18N
        ...
        btnMovUp.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
        ...
        btnMovDo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c052.gif"))); // NOI18N
        ...
        btnMovDo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
        ...
        btnMovRi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c046.gif"))); // NOI18N
        ...
        btnMovRi.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
        ...
        btnMovLe.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c048.gif"))); // NOI18N
        ...
        btnMovLe.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
        ...
        btnScale1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c094.gif"))); // NOI18N
        ...
        btnScale1.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
        ...
        btnScale2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c095.gif"))); // NOI18N
        ...
        btnScale2.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
        ...
        btnScelet.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c096.gif"))); // NOI18N
        ...
        btnScelet.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
    ...
    private void btnMove(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMove
        ...
        if (btn == btnMovDo) {
            UGeo.moveGson(winc.gson, .0, dxy, winc.scale);
        } else if (btn == btnMovUp) {
            UGeo.moveGson(winc.gson, .0, -dxy, winc.scale);
        } else if (btn == btnMovLe) {
            UGeo.moveGson(winc.gson, -dxy, .0, winc.scale);
