...
import frames.swing.column.ColumnGroup;
import frames.swing.column.GroupableTableHeader;
...
public class Specifics extends javax.swing.JFrame {
    ...
    ImageIcon[] image = {new javax.swing.ImageIcon(getClass().getResource("/img16/b063.gif")),
        new javax.swing.ImageIcon(getClass().getResource("/img16/b076.gif")),
        new javax.swing.ImageIcon(getClass().getResource("/img16/b077.gif")),
        new javax.swing.ImageIcon(getClass().getResource("/img16/b031.gif"))
    };
    ...
    public void loadingData() {
        ...
        if (this.man == true) {
            ...
            if (prjprodRec != null) {                
                ...
                ArrayList<TRecord> listKit = Kitcalc.tarifficProd(winc, prjprodRec, discKit, discAll, true, false); //комплекты
    ...
    private void initComponents() {
        ...
        mnAll.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img16/b031.gif"))); // NOI18N
        ...
        btnFind1.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
        ...
        btn21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c056.gif"))); // NOI18N
        ...
        btn22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c041.gif"))); // NOI18N
        ...
        btn22.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
    ...
    private void tab1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tab1MouseClicked
        ...
        if (evt.getButton() == MouseEvent.BUTTON3) {
            ...
            setText(mx, "PK = " + record.id + " - ИДЕНТИФИКАТОР ЗАПИСИ");
