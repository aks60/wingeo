...
public class ParName extends javax.swing.JDialog {
    ...
    public String loadHelpParam(int ID) {
        ...
        if (ID != -1) {
            try (Reader reader = new InputStreamReader(this.getClass()
                    .getResourceAsStream("/json/param_desc.json"), "windows-1251")) {
                ...
                System.out.println("Ошибка-1:ParName.loadingHelp() " + e);
            } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        btnCard4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c035.gif"))); // NOI18N
