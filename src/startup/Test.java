...
//        }
    ...
    private static void query() {
        ...
        }
        {
            //Пересчёт
            try {
                java.sql.Statement statement = Conn.сonnection().createStatement();
...
//        Test.init(intersection);
    ...
    public static void clearDataDB() {
        ...
        if (JOptionPane.showConfirmDialog(null, "УДАЛЕНИЕ ДАННЫХ В БАЗЕ № " + eProp.base_num.getProp(), "УДАЛЕНИЕ",
